...
class Driver
{
  public:
	...
	Driver()	
	{
		initkey("9bf6d3dcebf3ef59205c9be5548280fa529778286df67d2cb3e61f24c0dc4fc5286d59ca");
	}
	...
	*/
	...
	// 500+版本新增用户锁 同一时间只能有一个用户在操作驱动(单进程多线程，最大支持nproc/2) 进程结束后需要手动delete或者主动调用destroy释放资源，释放驱动,否则下次运行失败
	void destroy();
};
